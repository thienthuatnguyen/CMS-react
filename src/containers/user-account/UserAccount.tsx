          ...
          <div className="content-account">
            <div className="content-item">
              ...
              <div className="row-info">
                ...
                <div className="col-info">{formAccount.full_name ? formAccount.full_name : <LoadingData variant="text" width={'60%'} count={1}></LoadingData>}</div>
              </div>
              <div className="row-info">
                <div className="col-info">Số điện thoại:</div>
                <div className="col-info">{formAccount.phone_number ? formAccount.phone_number : <LoadingData variant="text" width={'40%'} count={1}></LoadingData>}</div>
              </div>
              <div className="row-info">
                <div className="col-info">Email:</div>
                <div className="col-info">{formAccount.email ? formAccount.email : <LoadingData variant="text" width={'50%'} count={1}></LoadingData>}</div>
              </div>
              {formAccount.ref_code && <div className="row-info">
                <div className="col-info">Mã giới thiệu:</div>
                <div className="col-info">{formAccount.ref_code ? formAccount.ref_code : <LoadingData variant="text" width={'50%'} count={1}></LoadingData>}</div>
              </div>
              }
            </div>
            <div className="content-item content-item-password">
              ...
              <div className="row-info">
                ...
                <div className="col-info">{formAccount.full_name ? <span>&#8226;&#8226;&#8226;&#8226;&#8226;&#8226;&#8226;&#8226;</span> : <LoadingData variant="text" width={'60%'} count={1}></LoadingData>}</div>
              </div>
            </div>
          </div>
        </div>
